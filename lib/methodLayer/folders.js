...
exports.delete = function (client, pass, callback){
	...
	client.delete(path, undefined, callback)
}
...
exports.getCollaborations = function (client, id, callback){
	...
	client.get(path, data, undefined, callback)
}
