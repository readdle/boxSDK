...
makeRequest = function (setStreamCallback, path, data, headers, method, waitUntilDate, NewTokensCallback, onDataReceiveCallback) {
    ...
    if (waitUntilTime > now) {
        ...
        setTimeout(function () {
            ...
            makeRequest(setStreamCallback, path, data, headers, method, waitUntilDate, NewTokensCallback);
        }, waitUntilTime - now);
        return;
    }
    ...
    var stream = request(options, onDataReceiveCallback).on('response', function (response) {
