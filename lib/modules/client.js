...
var client = {
    ...
    getToken: function (code, callb) {
        ...
        func.makeRequest(callb, this.path, this.data, this.headers, 'post', this.waitUntilDate);
    },
    ...
    revokeToken: function (token, callb) {
        ...
        func.makeRequest(callback, this.path, this.data, this.headers, 'post', this.waitUntilDate);
    },
    get: function (path, callb, extraHeader) {
        ...
        func.makeRequest(callb, this.path, null, this.headers, 'get', this.waitUntilDate);
    },
    ...
    put: function (path, data, callb) {
        ...
        this.headers = func.getHeaders(this.aToken, 'post', {user: this.user});
        this.data = JSON.stringify(data);
        func.makeRequest(callb, this.path, this.data, this.headers, 'put', this.waitUntilDate);
    },
    patch: function (path, data, callb) {
        this.path = path;
        this.headers = func.getHeaders(this.aToken, 'post', {user: this.user});
        this.data = JSON.stringify(data);
        func.makeRequest(callb, this.path, this.data, this.headers, 'patch', this.waitUntilDate);
    },
    delete: function (path, callb) {
        this.path = path;
        this.headers = func.getHeaders(this.aToken, 'get', {user: this.user});
        func.makeRequest(callb, this.path, null, this.headers, 'delete', this.waitUntilDate);
    },
    upload: function (path, file, callb) {
        this.path = path;
        this.headers = func.getHeaders(this.aToken, 'upload', {user: this.user});
        this.data = file;
        func.uploadFile(callb, path, this.data, this.headers, this.waitUntilDate);
    }
};
